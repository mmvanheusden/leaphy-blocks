...
messages["LEAPHY_READ_BINARY_CHARACTERISTIC_VALUE"] = "Lees waarde van binaire karakteristiek %1";
messages["LEAPHY_READ_STRING_CHARACTERISTIC_VALUE"] = "Lees waarde van string karakteristiek %1";
